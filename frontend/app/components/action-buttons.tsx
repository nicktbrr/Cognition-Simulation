...
// const prod = process.env.NEXT_DEV || "production";
...
// export default function ActionButtons({ onSubmit, steps }: ActionButtonsProps) {
//   const [isProcessing, setIsProcessing] = useState(false);
//   const [loading, setLoading] = useState(false);
//   const [publicUrl, setPublicUrl] = useState("");
//   const [stepwiseAverageSimilarity, setStepwiseAverageSimilarity] =
//     useState<any>("");
//   const [meanSimilarityDf, setMeanSimilarityDf] = useState<any>("");
...
//       const jsonData = {
//         seed: "some-seed-value", // Replace with actual seed
...
//           JSON.parse(data.evaluation.stepwise_similarity_df)
//         );
//         setMeanSimilarityDf(JSON.parse(data.evaluation.mean_similarity_df));
//         setPublicUrl(data.evaluation.public_url);
//       }
//     } catch (error) {
